...
import org.cisco.ciscoutil.cu.config.condition.JavaMelodyConfigurationCondition;
...
@Conditional(JavaMelodyConfigurationCondition.class)
public class JavaMelodyConfiguration implements ServletContextInitializer {
    ...
    public FilterRegistrationBean javaMelody() {
        ...
        javaMelody.addInitParameter(Parameter.AUTHORIZED_USERS.getCode(), 
        							properties.getJavaMelodyUserName() + ":" + properties.getJavaMelodyPassword());
